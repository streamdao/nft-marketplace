...
export const textContent = {
  ...
  titleDescription: `The first 2500 people to sign up will receive an ultra rare ${LABELS.STORE_NAME} Genesis NFT before we release it in Stream NFT marketplace.`,
  ////
